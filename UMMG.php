...
<ul class="nav justify-content-end bg-dark mb-3 rounded-pill border border-3">
    ...
    <li class="nav-item">
        <a href="FerryRegister2.php" class="nav-link fs-5 text-light">Ferry Register</a>
    </li>
</ul><!--
...
<h3 class="shadow-none p-4 mb-4 bg-body-secondary-subtle text-primary-emphasis fst-italic fw-bold text-center">University of Medicine Magway<abbr title=" University of Medicine Magway" style="text-decoration:none">(UMMG)</abbr></h3>
...
$sql = "SELECT CarNo FROM ferry WHERE UniId='3'";
    ...
    <div class="container text-center">
        <div class="row mb-5">
            ...
            while ($row1 = mysqli_fetch_assoc($result1)) {
                $qry = "SELECT UserName FROM userform,ferry WHERE CarNo='{$row1['CarNo']}' and UniId='3' and userform.Fid=ferry.Fid";
                            ...
                            <div class="col-md-4">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href='Register2.php?carno=<?php echo $row['CarNo']; ?>' class="btn btn-primary">Register</a>
                                    </div>
                                </div>
                            </div>
                            <?php
...
<ul class="pagination justify-content-end">
    ...
    <li class="page-item active"><a class="page-link" href="UMMG.php">UMMG</a></li>
</ul>
